...
$DBversion = "3.16.01.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.1 release)\n";
    SetVersion ($DBversion);
}

$DBversion = "3.16.02.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.2 release)\n";
    SetVersion ($DBversion);
}
...
$DBversion = "3.16.03.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.3 release)\n";
    SetVersion ($DBversion);
}

$DBversion = "3.16.04.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.4 release)\n";
    SetVersion ($DBversion);
}
