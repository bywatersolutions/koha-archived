...
<xslo:stylesheet xmlns:xslo="http://www.w3.org/1999/XSL/Transform" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:z="http://indexdata.com/zebra-2.0" xmlns:kohaidx="http://www.koha-community.org/schemas/index-defs" version="1.0">
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='510']">
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('a', @code)">
        <z:index name="bibliographic-reference:w">
          <xslo:value-of select="."/>
        </z:index>
      </xslo:if>
    </xslo:for-each>
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='653']">
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('a', @code)">
        <z:index name="Index-term-uncontrolled:w Index-term-uncontrolled:p Subject:w Subject:p Theme:p Theme:p">
          <xslo:value-of select="."/>
        </z:index>
      </xslo:if>
    </xslo:for-each>
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='791']">
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('b', @code)">
        <z:index name="LocalCorporateName:w LocalCorporateName:p">
          <xslo:value-of select="."/>
        </z:index>
      </xslo:if>
    </xslo:for-each>
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='796']">
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('a', @code)">
        <z:index name="LocalPersonalName:w LocalPersonalName:p">
          <xslo:value-of select="."/>
        </z:index>
      </xslo:if>
    </xslo:for-each>
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='880']">
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('a', @code)">
        <z:index name="Alternate-graphic-representation:w">
          <xslo:value-of select="."/>
        </z:index>
      </xslo:if>
    </xslo:for-each>
  ...
  <xslo:template mode="index_data_field" match="marc:datafield[@tag='586']">
    <z:index name="awards:w">
      <xslo:variable name="raw_heading">
        <xslo:for-each select="marc:subfield">
          <xslo:if test="position() &gt; 1">
